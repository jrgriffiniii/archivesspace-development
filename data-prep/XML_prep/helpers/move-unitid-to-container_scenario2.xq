...
for $ead in $eads
let $containers-in-spe := $ead//ead:dsc[1]//ead:unitid[@type='itemnumber' and not(../ead:container or ../ead:dao or ../../ead:c)]

(:return $containers-in-spe
:)
for $unitid in $containers-in-spe
return
replace node $unitid with <container type="item" xmlns="urn:isbn:1-931666-22-9">{$unitid/text()}</container>